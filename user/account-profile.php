...
<body>
  ...
  <span><?php echo isset($_SESSION['display_name']) ? htmlspecialchars($_SESSION['display_name']) : (isset($_SESSION['primer_nombre']) ? htmlspecialchars($_SESSION['primer_nombre']) : 'Usuario'); ?></span>
      </a>
                      ...
                      <div class="card">
                        <div class="card-body position-relative">
                          ...
                          <div class="text-center mt-3">
                            ...
                            <h5 class="mb-0"><?php echo isset($_SESSION['display_name']) ? htmlspecialchars($_SESSION['display_name']) : (isset($_SESSION['primer_nombre']) ? htmlspecialchars($_SESSION['primer_nombre']) : 'Usuario'); ?></h5>
                            <hr class="my-3">
                            <div class="row g-3">
                              <div class="col-4">
                                <h5 class="mb-0">86</h5>
                            ...
                            <div class="d-inline-flex align-items-center justify-content-between w-100 mb-3">
                              ...
                              <p class="mb-0"><?php echo $_SESSION['direccion']; ?></p>
                            </div>
                            <!-- Campo de link eliminado -->
                          </div>
                        </div>
                      </div>
                      <div class="card">
