...
<body class="landing-page">
  ...
  <section class="position-relative p-0">
    ...
    <div class="img-comp-container">
      <div class="img-comp-img">
        <img src="admin/assets/images/landing/img-theme-light-1.jpg" alt="img" data-img-type=".jpg" class="img-landing"
          data-img="admin/assets/images/landing/img-theme-light-">
      </div>
      <div class="img-comp-img img-comp-overlay">
        <img src="admin/assets/images/landing/img-theme-dark-1.jpg" alt="img" data-img-type=".jpg" class="img-landing"
          data-img="admin/assets/images/landing/img-theme-dark-">
      </div>
    </div>
  </section>
  <!-- [ light/dark ] End -->
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-9 position-relative img-webapp-block">
          <img src="admin/assets/images/landing/img-element-main-theme-1.png" alt="img" data-img-type=".png"
            class="img-landing img-fluid" data-img="admin/assets/images/landing/img-element-main-theme-">
          <img src="admin/assets/images/landing/img-element-msg.png" alt="img" class="img-fluid img-msg">
          <img src="admin/assets/images/landing/img-element-widget.png" alt="img" class="img-fluid img-widget">
        </div>
        <div class="col-lg-9 position-relative img-webapp-block">
          <div class="row mt-5">
            <div class="col-md-4">
  ...
  <section class="client-block">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center mb-4 mb-md-5">
        ...
        <div class="col-auto my-2">
          <img src="admin/assets/images/landing/client-02.png" alt="img" class="img-fluid wow fadeInUp"
            data-wow-delay="0.4s">
        </div>
        <div class="col-auto my-2">
          <img src="admin/assets/images/landing/client-03.png" alt="img" class="img-fluid wow fadeInUp"
            data-wow-delay="0.6s">
        </div>
        <div class="col-auto my-2">
          <img src="admin/assets/images/landing/client-04.png" alt="img" class="img-fluid wow fadeInUp"
            data-wow-delay="0.8s">
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card wow fadeInRight" data-wow-delay="0.4s">
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="admin/assets/images/landing/img-user1.svg" alt="img" class="img-fluid wid-40">
                </div>
                <div class="flex-grow-1 ms-3">
                  <h5 class="mb-1">Code Quality</h5>
                  <div class="star f-12 mb-3">
  ...
  <footer class="footer bg-dark text-white">
    <div class="top-footer footer-moke pb-0">
      <img src="admin/assets/images/landing/img-footer-moke-1.png" alt="img" data-img-type=".png"
        class="img-fluid img-footer img-landing" data-img="../assets/images/landing/img-footer-moke-">
      <div class="container">
        <div class="row">
    ...
    <div class="top-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <img src="admin/assets/images/pages/codedthemes-logo.svg" alt="image" class="img-fluid mb-3">
