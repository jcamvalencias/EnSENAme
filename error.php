          ...
          <div class="card error-card">
            <div class="card-body">
              ...
              <div class="text-center">
                <h1 class="mt-4"><b>Error con el registro</b></h1>
                <p class="mt-2 mb-4 text-sm text-muted">Problema con el registro</p>
                <button type="button" onclick="window.location.href='index.php'" class="btn btn-primary mb-3">Go to homepage</button>
              </div>
            </div>
          </div>
        </div>
